...
> Setelah stack & package manager dipilih, daftarkan script ini di manifest (`package.json` scripts / setara) lalu pakai:
```bash
...
```
> gitleaks, semgrep, trivy adalah CLI eksternal — install terpisah (lihat `docs/MCP_RECOMMENDATIONS.md`).
